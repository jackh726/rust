...
pub struct RegionInferenceContextData<'tcx> {
...
pub struct RegionInferenceContext<'tcx> {
    data: Frozen<RegionInferenceContextData<'tcx>>,
}

impl<'tcx> Deref for RegionInferenceContext<'tcx> {
    type Target = RegionInferenceContextData<'tcx>;
...
impl<'tcx> RegionInferenceContext<'tcx> {
    pub(crate) fn new(unsolved_region_context: UnsolvedRegionInferenceContext<'tcx>) -> Self {
        Self { data: Frozen::freeze(unsolved_region_context.data) }
    }
}

impl<'tcx> RegionInferenceContextData<'tcx> {
