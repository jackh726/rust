...
fn _is_hash_stable<'a, T: crate::ty::HashStable<crate::ty::StableHashingContext<'a>>>(_t: T) {}
fn _ty_hash_stable<'tcx>(_t: Ty<'tcx>) { _is_hash_stable(_t); }
...
impl<'a, 'tcx> crate::ty::HashStable<crate::ty::StableHashingContext<'a>> for FnSig<'tcx> {
    fn hash_stable(&self, hcx: &mut crate::ty::StableHashingContext<'a>, hasher: &mut crate::ty::StableHasher) {
        self.inputs_and_output.hash_stable(hcx, hasher);
        self.c_variadic.hash_stable(hcx, hasher);
        self.unsafety.hash_stable(hcx, hasher);
