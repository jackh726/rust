...
impl<'tcx> HashStable<StableHashingContext<'tcx>> for TyS<'tcx> {
...
impl<'tcx> HashStable<StableHashingContext<'tcx>> for Predicate<'tcx> {
    fn hash_stable(&self, hcx: &mut StableHashingContext<'tcx>, hasher: &mut StableHasher) {
        let PredicateInner {
            ref kind,
...
impl<'tcx> HashStable<StableHashingContext<'tcx>> for ParamEnv<'tcx> {
    fn hash_stable(&self, hcx: &mut StableHashingContext<'tcx>, hasher: &mut StableHasher) {
...
impl<'tcx, T> HashStable<StableHashingContext<'tcx>> for ParamEnvAnd<'tcx, T>
where
