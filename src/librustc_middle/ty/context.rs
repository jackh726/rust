...
pub struct CtxtInterners<'tcx> {
    ...
    predicate_kint: InternedSet<'tcx, PredicateKind<'tcx>>,
...
nop_lift! {predicate_kint; &'a PredicateKind<'a> => &'tcx PredicateKind<'tcx>}
...
direct_interners! {
    ...
    predicate_kint: intern_predicate_kint(PredicateKind<'tcx>),
}
